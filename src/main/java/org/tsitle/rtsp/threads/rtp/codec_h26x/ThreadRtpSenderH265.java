...
public final class ThreadRtpSenderH265 extends ThreadRtpSenderH26xBase<H265Info, ThreadDataProvH265> {
	...
	@Override
	protected H265Info getCloneOfH26xInfo(@NonNull H265Info src) {
		return src.clone();
	}
