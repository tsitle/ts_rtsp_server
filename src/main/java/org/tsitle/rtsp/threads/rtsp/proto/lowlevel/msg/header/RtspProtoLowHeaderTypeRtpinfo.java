...
public class RtspProtoLowHeaderTypeRtpinfo {
	...
	public static class SubStream {
		...
		public void setSeqNr16bit(int seqNr16bit) throws IllegalArgumentException {
			if (seqNr16bit < 0 || seqNr16bit > 0xFFFF) {
				throw new IllegalArgumentException("seqNr16bit must be non-negative and within 16-bit range");
			}
		...
		public void setRtpTimestamp32bit(long rtpTimestamp32bit) throws IllegalArgumentException {
			if (rtpTimestamp32bit < 0L || rtpTimestamp32bit > 0xFFFFFFFFL) {
				throw new IllegalArgumentException("rtpTimestamp32bit must be non-negative and within 32-bit range");
			}
		...
		public void setSsrcId32bit(long ssrc32bit) throws IllegalArgumentException {
			if (ssrc32bit < 1L || ssrc32bit > 0xFFFFFFFFL) {
				throw new IllegalArgumentException("ssrc32bit must be between 1 and 0xFFFFFFFF, got: " + ssrc32bit);
			}
