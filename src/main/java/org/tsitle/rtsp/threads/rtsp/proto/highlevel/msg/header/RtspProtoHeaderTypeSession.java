...
public class RtspProtoHeaderTypeSession {
	...
	public void setTimeout32bit(long timeout32bit) throws IllegalArgumentException {
		if (timeout32bit < 0L || timeout32bit > 0xFFFFFFFFL) {
			throw new IllegalArgumentException("timeout32bit must be non-negative and within 32-bit range");
		}
