...
public final class MikeyParser {
	 ...
	 * @throws SrtxpSecurityException If any kind of error occurred
	 */
	private static @NonNull SrtxpKmd extractKmdFromMd(@NonNull MikeyData mikeyData) throws SrtxpSecurityException {
	 ...
	 * @throws SrtxpSecurityException If any kind of error occurred
	 */
	private static @NonNull MikeyData parseMickeyMsg(@NonNull String msgB64) throws SrtxpSecurityException {
