 ...
 */
public final class RtspConfigMuxedStreamSourceOLDDD {
	...
	public RtspConfigMuxedStreamSourceOLDDD() {
		this.id = -1;
		this.enabled = true;
		this.filePath = "";
		this.rtspUrl = "";
	...
	private void readSubStreamInfos(@NonNull String extMsId) throws ConfigInvalidException {
		...
		final String realUri = getInputUri().toString()
				.replace("http://", "rtsp://")
				.replace("https://", "rtsps://");
		final String errMsgUri = RtspConfigElementaryStreamSourceOLDDD.buildMsSourceUriForErrorMsgs(getInputUri());
