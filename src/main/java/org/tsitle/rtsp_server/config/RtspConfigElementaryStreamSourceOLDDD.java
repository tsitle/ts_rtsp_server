 ...
 */
public final class RtspConfigElementaryStreamSourceOLDDD {
	...
	@Expose
	private @Nullable RtspConfigEsMqOLDDD mq;
	...
	public RtspConfigElementaryStreamSourceOLDDD() {
		this.id = -1;
		this.enabled = true;
		this.filePath = "";
		this.mq = null;
	...
	static @NonNull RtspConfigElementaryStreamSourceOLDDD createFromDemuxedSubStreamVideo(
				int esSourceId,
				int msSourceId,
				@NonNull URI msSourceUri,
				@NonNull FfmpegDmxSubStreamInfoVideo subStreamInfo
			) throws ConfigInvalidException {
		final String FNC_NAME = RtspConfigElementaryStreamSourceOLDDD.class.getSimpleName() + ".createFromDemuxedSubStreamVideo()";

		final String errMsgUri = buildMsSourceUriForErrorMsgs(msSourceUri);

		RtspConfigElementaryStreamSourceOLDDD resObj = new RtspConfigElementaryStreamSourceOLDDD();
	...
	static @NonNull RtspConfigElementaryStreamSourceOLDDD createFromDemuxedSubStreamAudio(
				int esSourceId,
				int msSourceId,
				@NonNull URI msSourceUri,
				@NonNull FfmpegDmxSubStreamInfoAudio subStreamInfo
			) throws ConfigInvalidException {
		final String FNC_NAME = RtspConfigElementaryStreamSourceOLDDD.class.getSimpleName() + ".createFromDemuxedSubStreamAudio()";
	...
	void validate(
		...
		//
		ReadEsRawFileMetaOLDDD.readMeta(tmpExtSsId, this);
	}
	...
	private static @NonNull RtpPacketType convertFfmpegVideoCodecToRtpPacketType(@NonNull FfmpegCodec ffmpegCodec)
			throws ConfigInvalidException {
		final String FNC_NAME = RtspConfigElementaryStreamSourceOLDDD.class.getSimpleName() + ".convertFfmpegVideoCodecToRtpPacketType()";
	...
	private static @NonNull RtpPacketType convertFfmpegAudioCodecToRtpPacketType(
		...
		final String FNC_NAME = RtspConfigElementaryStreamSourceOLDDD.class.getSimpleName() + ".convertFfmpegAudioCodecToRtpPacketType()";
