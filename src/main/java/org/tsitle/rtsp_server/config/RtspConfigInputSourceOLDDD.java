 ...
 */
public final class RtspConfigInputSourceOLDDD implements Cloneable {
	...
	public RtspConfigInputSourceOLDDD() {
		this.id = "";
		this.enabled = true;
	...
	@Override
	public RtspConfigInputSourceOLDDD clone() {
		try {
			RtspConfigInputSourceOLDDD clone = (RtspConfigInputSourceOLDDD)super.clone();
	 ...
	 */
	void validate(
				@NonNull Map<@NonNull Integer, @NonNull RtspConfigElementaryStreamSourceOLDDD> elementaryStreamSources,
				@NonNull Map<@NonNull Integer, @NonNull String> mapEsSourceIdIntToExt,
				@NonNull Map<@NonNull Integer, @NonNull RtspConfigMuxedStreamSourceOLDDD> muxedStreamSources,
