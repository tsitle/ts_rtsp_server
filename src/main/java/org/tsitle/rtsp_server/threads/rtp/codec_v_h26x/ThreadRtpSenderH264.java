...
import org.tsitle.lib_dataprov.threads_es.codec_v_h26x.ThreadDataProvEsH264FromDmxFc;
...
public final class ThreadRtpSenderH264<AVSTRIC extends AvStreamIncomingBase>
	...
	protected @NonNull ThreadDataProvEsBase<VideoH264Info> newThreadDataProv() {
		if (avStreamIncomingType == AvStreamIncomingFromEsRawFile.class) {
			return new ThreadDataProvEsH264FromRawFile(
		...
		if (avStreamIncomingType == AvStreamIncomingFromDmxFc.class) {
			return new ThreadDataProvEsH264FromDmxFc(
					paramsCommon.copyToThreadDpCommon()
				);
		}
