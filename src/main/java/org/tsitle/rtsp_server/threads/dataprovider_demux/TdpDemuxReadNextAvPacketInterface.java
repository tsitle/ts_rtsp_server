...
public interface TdpDemuxReadNextAvPacketInterface {
	...
	void readNextPacketVideo(@NonNull BufferExt buf, @NonNull TimestampEpochNs stTimestamp)
			throws InputStreamEosException, InputStreamThreadEndedException;

	void readNextPacketAudio(@NonNull BufferExt buf, @NonNull TimestampEpochNs stTimestamp)
			throws InputStreamEosException, InputStreamThreadEndedException;
